        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('companies.index') }}" class="text-muted text-hover-primary">{{ __('dashboard.companies') }}</a>
                    </li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ isset($company) ? route('companies.update', $company->id) : route('companies.store') }}"
                        ...
                        <!--begin::Company Name-->
                        <div class="row mb-6">
                            <label class="col-lg-3 col-form-label required fw-bold fs-6">{{ __('dashboard.company_name') }}</label>
                            <div class="col-lg-9">
                                <input type="text"
                                       class="form-control form-control-solid @error('name') is-invalid @enderror"
                                       name="name"
                                       value="{{ old('name', isset($company) ? $company->name : '') }}"
                                       placeholder="{{ __('dashboard.company_name') }}"
                                       required />
                                @error('name')
                        ...
                        <!--begin::Contract Type-->
                        <div class="row mb-6">
                            <label class="col-lg-3 col-form-label required fw-bold fs-6">{{ __('dashboard.contract_type') }}</label>
                            <div class="col-lg-9">
                                <select class="form-select form-select-solid @error('contract_type') is-invalid @enderror"
                                        name="contract_type"
                                        id="contract_type"
                                        required>
                                    <option value="">{{ __('dashboard.select_contract_type') }}</option>
                                    <option value="percentage" {{ old('contract_type', isset($company) ? $company->contract_type : '') == 'percentage' ? 'selected' : '' }}>
                                        {{ __('dashboard.percentage') }}
                                    </option>
                                    <option value="fixed" {{ old('contract_type', isset($company) ? $company->contract_type : 'fixed') == 'fixed' ? 'selected' : '' }}>
                                        {{ __('dashboard.fixed') }}
                                    </option>
                                </select>
                                @error('contract_type')
                        ...
                        <div class="row mb-6" id="contract_value_group" style="display: none;">
                            <label class="col-lg-3 col-form-label fw-bold fs-6">{{ __('dashboard.contract_value') }}</label>
                            <div class="col-lg-9">
                        ...
                        <!--begin::Status-->
                        <div class="row mb-6">
                            <label class="col-lg-3 col-form-label fw-bold fs-6">{{ __('dashboard.status') }}</label>
                            <div class="col-lg-9">
