                ...
                <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_companies_table">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <!--begin::Status-->
                                    <td>
                                        <span class="badge badge-light-{{ $company->is_active ? 'success' : 'danger' }}">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('companies.edit', $company->id) }}" class="menu-link px-3">
                                                    {{ __('dashboard.edit') }}
                                                </a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <form action="{{ route('companies.destroy', $company->id) }}" method="POST" class="d-inline" onsubmit="return confirm('{{ __('dashboard.confirm_delete') }}')">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-10">
                                        <div class="text-gray-600 fs-5">{{ __('dashboard.no_companies_found') }}</div>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap pt-5">
                        <div class="fs-6 fw-bold text-gray-700">
                            {{ __('dashboard.showing') }} {{ $companies->firstItem() ?? 0 }} {{ __('dashboard.to') }} {{ $companies->lastItem() ?? 0 }} {{ __('dashboard.of') }} {{ $companies->total() }} {{ __('dashboard.entries') }}
                        </div>
                        {{ $companies->links() }}
                    </div>
                    <!--end::Pagination-->
