                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="account_name" class="form-control form-control-solid @error('account_name') is-invalid @enderror" value="{{ old('account_name') }}" required />
                                @error('account_name')
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="account_number" class="form-control form-control-solid @error('account_number') is-invalid @enderror" value="{{ old('account_number') }}" />
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <select name="account_type" class="form-select form-select-solid @error('account_type') is-invalid @enderror">
                                    ...
                                    <option value="Competitor" {{ old('account_type') == 'Competitor' ? 'selected' : '' }}>Competitor</option>
                                    <option value="Vendor" {{ old('account_type') == 'Vendor' ? 'selected' : '' }}>Vendor</option>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="industry" class="form-control form-control-solid @error('industry') is-invalid @enderror" value="{{ old('industry') }}" />
                                @error('industry')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="annual_revenue" class="form-control form-control-solid @error('annual_revenue') is-invalid @enderror" value="{{ old('annual_revenue') }}" />
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="number" name="employees" class="form-control form-control-solid @error('employees') is-invalid @enderror" value="{{ old('employees') }}" min="0" />
                                @error('employees')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="phone" class="form-control form-control-solid @error('phone') is-invalid @enderror" value="{{ old('phone') }}" />
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="url" name="website" class="form-control form-control-solid @error('website') is-invalid @enderror" value="{{ old('website') }}" placeholder="https://example.com" />
                                @error('website')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <textarea name="billing_street" class="form-control form-control-solid @error('billing_street') is-invalid @enderror" rows="2">{{ old('billing_street') }}</textarea>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="billing_city" class="form-control form-control-solid @error('billing_city') is-invalid @enderror" value="{{ old('billing_city') }}" />
                                @error('billing_city')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="billing_state" class="form-control form-control-solid @error('billing_state') is-invalid @enderror" value="{{ old('billing_state') }}" />
                                @error('billing_state')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="billing_code" class="form-control form-control-solid @error('billing_code') is-invalid @enderror" value="{{ old('billing_code') }}" />
                                @error('billing_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="billing_country" class="form-control form-control-solid @error('billing_country') is-invalid @enderror" value="{{ old('billing_country') }}" />
