...
@section('title', __('dashboard.add_new_contact'))
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('dashboard.add_new_contact') }}</h3>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                       value="{{ old('title') }}" placeholder="e.g. Sales Manager" />
                                @error('title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            <div class="col-md-12">
                                ...
                                <textarea name="mailing_street" class="form-control @error('mailing_street') is-invalid @enderror" rows="2">{{ old('mailing_street') }}</textarea>
