...
@section('title', __('dashboard.add_new_deal'))
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('dashboard.add_new_deal') }}</h3>
                </div>
                        ...
                        <div class="row mb-6">
                            <div class="col-md-6">
                                ...
                                <select name="stage" class="form-select @error('stage') is-invalid @enderror" required>
                                    ...
                                    <option value="Needs Analysis" {{ old('stage') == 'Needs Analysis' ? 'selected' : '' }}>Needs Analysis</option>
                                    <option value="Value Proposition" {{ old('stage') == 'Value Proposition' ? 'selected' : '' }}>Value Proposition</option>
                                    <option value="Proposal/Price Quote" {{ old('stage') == 'Proposal/Price Quote' ? 'selected' : '' }}>Proposal/Price Quote</option>
                                    <option value="Negotiation/Review" {{ old('stage') == 'Negotiation/Review' ? 'selected' : '' }}>Negotiation/Review</option>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="type" class="form-select @error('type') is-invalid @enderror">
                                    <option value="">{{ __('dashboard.select') }}</option>
                                    <option value="New Business" {{ old('type') == 'New Business' ? 'selected' : '' }}>New Business</option>
                                    <option value="Existing Business" {{ old('type') == 'Existing Business' ? 'selected' : '' }}>Existing Business</option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" max="100" name="probability" class="form-control @error('probability') is-invalid @enderror"
                                       value="{{ old('probability') }}" placeholder="0-100" />
                                @error('probability')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
