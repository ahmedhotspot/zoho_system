...
@section('title', __('dashboard.edit_task'))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="subject" class="form-control form-control-solid @error('subject') is-invalid @enderror" value="{{ old('subject', $task->subject) }}" required />
                                @error('subject')
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <input type="date" name="due_date" class="form-control form-control-solid @error('due_date') is-invalid @enderror" value="{{ old('due_date', $task->due_date ? $task->due_date->format('Y-m-d') : '') }}" />
                                @error('due_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <select name="status" class="form-select form-select-solid @error('status') is-invalid @enderror">
                                    ...
                                    <option value="Waiting for input" {{ old('status', $task->status) == 'Waiting for input' ? 'selected' : '' }}>Waiting for input</option>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <select name="priority" class="form-select form-select-solid @error('priority') is-invalid @enderror">
                                    <option value="">{{ __('dashboard.select') }}</option>
                                    <option value="Highest" {{ old('priority', $task->priority) == 'Highest' ? 'selected' : '' }}>Highest</option>
                                    <option value="High" {{ old('priority', $task->priority) == 'High' ? 'selected' : '' }}>High</option>
                                    <option value="Normal" {{ old('priority', $task->priority) == 'Normal' ? 'selected' : '' }}>Normal</option>
                                    <option value="Low" {{ old('priority', $task->priority) == 'Low' ? 'selected' : '' }}>Low</option>
                                    <option value="Lowest" {{ old('priority', $task->priority) == 'Lowest' ? 'selected' : '' }}>Lowest</option>
                                </select>
                                @error('priority')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9">
                                <textarea name="description" class="form-control form-control-solid @error('description') is-invalid @enderror" rows="4">{{ old('description', $task->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
