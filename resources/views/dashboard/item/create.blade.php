...
@section('title', __('dashboard.add_new_item'))
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('dashboard.add_new_item') }}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">{{ __('dashboard.add_new_item') }}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title-->
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <!--begin::Form-->
            <form action="{{ route('items.store') }}" method="POST" id="kt_item_form">
                @csrf
                <!--begin::Card-->
                <div class="card">
                    <!--begin::Card header-->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid @error('item_type') is-invalid @enderror" 
                                        ...
                                        <option value="sales" {{ old('item_type') == 'sales' ? 'selected' : '' }}>{{ __('dashboard.sales') }}</option>
                                        <option value="purchases" {{ old('item_type') == 'purchases' ? 'selected' : '' }}>{{ __('dashboard.purchases') }}</option>
                                        <option value="sales_and_purchases" {{ old('item_type') == 'sales_and_purchases' ? 'selected' : '' }}>{{ __('dashboard.sales_and_purchases') }}</option>
                                        <option value="inventory" {{ old('item_type') == 'inventory' ? 'selected' : '' }}>{{ __('dashboard.inventory') }}</option>
                                    </select>
                                    @error('item_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid @error('product_type') is-invalid @enderror" 
                                        ...
                                        <option value="">{{ __('dashboard.select') }}</option>
                                        <option value="goods" {{ old('product_type') == 'goods' ? 'selected' : '' }}>{{ __('dashboard.goods') }}</option>
                                        <option value="service" {{ old('product_type') == 'service' ? 'selected' : '' }}>{{ __('dashboard.service') }}</option>
                                    </select>
                                    @error('product_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control form-control-solid @error('purchase_rate') is-invalid @enderror" 
                                           name="purchase_rate" value="{{ old('purchase_rate') }}" />
                                    @error('purchase_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-solid @error('unit') is-invalid @enderror" 
                                           name="unit" value="{{ old('unit') }}" placeholder="kg, pcs, etc." />
                                    @error('unit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="fv-row mb-7">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" name="is_taxable" value="1" id="is_taxable" {{ old('is_taxable', true) ? 'checked' : '' }} />
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('items.index') }}" class="btn btn-light btn-active-light-primary me-2">{{ __('dashboard.cancel') }}</a>
