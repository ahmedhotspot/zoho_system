...
@section('title', __('dashboard.add_new_estimate'))
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('dashboard.add_new_estimate') }}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">{{ __('dashboard.add_new_estimate') }}</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title-->
            ...
            <div class="card">
                ...
                <div class="card-body p-lg-17">
                    <form action="{{ route('estimates.store') }}" method="POST">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <label class="form-label required">{{ __('dashboard.customer') }}</label>
                                ...
                                <div class="item-row border p-4 mb-3 rounded">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <select name="items[0][item_id]" class="form-select item-select" required>
                                                ...
                                                @foreach($items as $item)
                                                    <option value="{{ $item->id }}" data-rate="{{ $item->purchase_rate }}">
                                                        {{ $item->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" name="items[0][quantity]" class="form-control" step="0.01" min="0.01" value="1" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label required">{{ __('dashboard.rate') }}</label>
                                            <input type="number" name="items[0][rate]" class="form-control rate-input" step="0.01" min="0" value="0" required>
                                        </div>
                                        <div class="col-md-3">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('estimates.index') }}" class="btn btn-light me-3">{{ __('dashboard.cancel') }}</a>
