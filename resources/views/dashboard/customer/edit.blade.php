...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('dashboard.edit_customer') }}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{ __('dashboard.edit_customer') }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <!--begin::Form-->
            <form action="{{ route('customers.update', $customer->id) }}" method="POST" id="kt_customer_form">
                @csrf
                @method('PUT')
                <!--begin::Card-->
                <div class="card">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-solid @error('contact_name') is-invalid @enderror" 
                                           name="contact_name" value="{{ old('contact_name', $customer->contact_name) }}" required />
                                    @error('contact_name')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid @error('contact_type') is-invalid @enderror" 
                                        ...
                                        <option value="customer" {{ old('contact_type', $customer->contact_type) == 'customer' ? 'selected' : '' }}>{{ __('dashboard.customer_type') }}</option>
                                        <option value="vendor" {{ old('contact_type', $customer->contact_type) == 'vendor' ? 'selected' : '' }}>{{ __('dashboard.vendor_type') }}</option>
                                        <option value="both" {{ old('contact_type', $customer->contact_type) == 'both' ? 'selected' : '' }}>{{ __('dashboard.both_type') }}</option>
                                    </select>
                                    @error('contact_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="url" class="form-control form-control-solid @error('website') is-invalid @enderror" 
                                           name="website" value="{{ old('website', $customer->website) }}" placeholder="https://" />
                                    @error('website')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <a href="{{ route('customers.show', $customer->id) }}" class="btn btn-light btn-active-light-primary me-2">{{ __('dashboard.cancel') }}</a>
